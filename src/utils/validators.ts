...
function checkEmpty(value: any, required: boolean, messages = resources) {
...
function msg(text: string, ...theArgs: any) {
  if (text !== null && theArgs.length > 1) {
...
const validators = {
  resources,
  required(value: any, field: TField, model: IModel, messages = resources) {
    return checkEmpty(value, field.required, messages);
  },

  number(value: number, field: TField, model: IModel, messages = resources) {
  ...
  integer(value: number, field: TField, model: IModel, messages = resources) {
    const res = checkEmpty(value, field.required, messages);
    if (res !== null) return res;
  ...
  double(value: number, field: TField, model: IModel, messages = resources) {
    const res = checkEmpty(value, field.required, messages);
    if (res !== null) return res;
  ...
  string(value: string, field: TField, model: IModel, messages = resources) {
    const res = checkEmpty(value, field.required, messages);
    if (res !== null) return res;
  ...
  array(value: any, field: TField, model: IModel, messages = resources) {
    if (field.required) {
      if (!isArray(value)) {
  ...
  regexp(value: string, field: TField, model: IModel, messages = resources) {
    const res = checkEmpty(value, field.required, messages);
    if (res !== null) return res;
  ...
  email(value: string, field: TField, model: IModel, messages = resources) {
    const res = checkEmpty(value, field.required, messages);
    if (res !== null) return res;

    const re = /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,4}$/; // eslint-disable-line no-useless-escape
    if (!re.test(value)) {
  ...
  url(value: string, field: TField, model: IModel, messages = resources) {
    const res = checkEmpty(value, field.required, messages);
    if (res !== null) return res;
  ...
  creditCard(value: string, field: TField, model: IModel, messages = resources) {
    const res = checkEmpty(value, field.required, messages);
    if (res !== null) return res;
  ...
  alpha(value: string, field: TField, model: IModel, messages = resources) {
    const res = checkEmpty(value, field.required, messages);
    if (res !== null) return res;
  ...
  alphaNumeric(value: string, field: TField, model: IModel, messages = resources) {
    const res = checkEmpty(value, field.required, messages);
    if (res !== null) return res;
...
Object.keys(validators).forEach((name) => {
  const fn: any = validators[name as keyof typeof validators];
  if (isFunction(fn)) {
    (fn as any).locale = (customMessages: any) => (value: any, field: TField, model: IModel) =>
